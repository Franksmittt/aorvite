...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      { id: 'fb-3', stepOrder: 12, taskName: '12. Front parking sensors seated (L/R) — 4 photos: top + side each side', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      ...
      { id: 'fb-qa-wire', stepOrder: 109, phase: 'Final Inspection', taskName: 'Electrical re-test after full fitment: sensors, indicators, DRL, spotlights', requiresPhoto: false, skippable: false },
