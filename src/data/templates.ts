...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'rst-wheels', stepOrder: 2, taskName: 'Remove rear wheels — 2 photos', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'rst-susp-left', stepOrder: 3, taskName: 'Left-side suspension condition — 2 photos', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'rst-susp-right', stepOrder: 4, taskName: 'Right-side suspension condition — 2 photos', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'rst-shock-l-out', stepOrder: 5, taskName: 'Left rear shock removed — top bolt + bottom bolt; photo of mounts', requiresPhoto: true, skippable: false },
      { id: 'rst-shock-r-out', stepOrder: 6, taskName: 'Right rear shock removed — top bolt + bottom bolt; photo of mounts', requiresPhoto: true, skippable: false },
      { id: 'rst-shock-l-in', stepOrder: 7, taskName: 'New left rear shock fitted — top + bottom bolts torqued (photo)', requiresPhoto: true, skippable: false },
      { id: 'rst-shock-r-in', stepOrder: 8, taskName: 'New right rear shock fitted — top + bottom bolts torqued (photo)', requiresPhoto: true, skippable: false },
      { id: 'rst-5', stepOrder: 9, taskName: 'Brake lines and ABS wiring checked for stretch / clearance', requiresPhoto: false, skippable: false },
      { id: 'rst-6', stepOrder: 10, taskName: 'Trailer plug / tow socket fitted and wired', requiresPhoto: true, skippable: false },
      { id: 'rst-7', stepOrder: 11, taskName: 'Trailer lights function test (indicators, brakes, tail, reverse)', requiresPhoto: false, skippable: false },
      { id: 'rst-8', stepOrder: 12, taskName: 'Final rear ride-height and tow-plug photos', requiresPhoto: true, skippable: false },
      ...FINAL_INSPECTION,
      ...
      { id: 'rst-qa-torque', stepOrder: 108, phase: 'Final Inspection', taskName: 'Wheel nuts and rear shock bolts re-torqued after road test', requiresPhoto: false, skippable: false },
      { id: 'rst-qa-height', stepOrder: 109, phase: 'Final Inspection', taskName: 'Rear ride height checked; brake lines and clearance rechecked', requiresPhoto: false, skippable: false },
      ...FINAL_RELEASE,
    ],
  },
  {
