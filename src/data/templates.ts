...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      // Strip order (Hilux): bumper off → mid cover → crash bar + covers → bash plate → chassis photo
      ...
      { id: 'fb-2', stepOrder: 10, taskName: 'Photo of fully stripped front chassis; all clips, bolts, and washers accounted for', requiresPhoto: true, skippable: false },
      { id: 'fb-3', stepOrder: 11, taskName: 'Front parking sensors transferred and seated correctly (L/R)', requiresPhoto: false, skippable: true },
      { id: 'fb-4', stepOrder: 12, taskName: 'Indicators / fog lights / DRL mounted with correct fasteners', requiresPhoto: false, skippable: true },
      { id: 'fb-5', stepOrder: 13, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 14, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
