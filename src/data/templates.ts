...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      // Vehicle OEM L then R: remove → photo before splice → splice untaped → tape up → refit tightened.
      { id: 'fb-lights-remove-l', stepOrder: 13, taskName: '13. Remove vehicle LEFT light — photo light off vehicle', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-presplice-l', stepOrder: 14, taskName: '14. LEFT ready to piggyback — photo BEFORE splicing', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-l', stepOrder: 15, taskName: '15. LEFT spliced/joined — NOT taped yet; photo joints', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-taped-l', stepOrder: 16, taskName: '16. LEFT joints taped up — photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-refit-l', stepOrder: 17, taskName: '17. Refit vehicle LEFT light — fasteners seated and tightened; photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-remove-r', stepOrder: 18, taskName: '18. Remove vehicle RIGHT light — photo light off vehicle', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-presplice-r', stepOrder: 19, taskName: '19. RIGHT ready to piggyback — photo BEFORE splicing', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-r', stepOrder: 20, taskName: '20. RIGHT spliced/joined — NOT taped yet; photo joints', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-taped-r', stepOrder: 21, taskName: '21. RIGHT joints taped up — photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-refit-r', stepOrder: 22, taskName: '22. Refit vehicle RIGHT light — fasteners seated and tightened; photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-fog', stepOrder: 23, taskName: '23. Wire centre fog lights into vehicle fog circuit (piggyback L+R); photo both joins', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'fb-lights-test', stepOrder: 24, taskName: '24. Function test lights: DRL/park L+R, indicator L+R+hazards, both fogs — photo each mode working', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-3', stepOrder: 25, taskName: '25. Front parking sensors seated (L/R) — 4 photos: top + side each side', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-5', stepOrder: 26, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 27, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
