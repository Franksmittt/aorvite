...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      // Strip order: top cover above grille first, then bottom screws + wheel-arch clips
      ...
      { id: 'fb-strip-2', stepOrder: 3, taskName: 'Remove screws from bottom of bumper + clips from wheel arches (both sides); photo', requiresPhoto: true, skippable: false },
      { id: 'fb-2', stepOrder: 4, taskName: 'Bumper / grille off — photo of stripped front chassis; all clips, bolts, and washers accounted for', requiresPhoto: true, skippable: false },
      { id: 'fb-3', stepOrder: 5, taskName: 'Front parking sensors transferred and seated correctly (L/R)', requiresPhoto: false, skippable: true },
      { id: 'fb-4', stepOrder: 6, taskName: 'Indicators / fog lights / DRL mounted with correct fasteners', requiresPhoto: false, skippable: true },
      { id: 'fb-5', stepOrder: 7, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 8, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
