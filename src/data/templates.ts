...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      // Bumper lights come prebuilt. Vehicle OEM L/R lights: remove → piggyback splice → refit tightened.
      { id: 'fb-lights-remove-l', stepOrder: 13, taskName: '13. Remove vehicle LEFT light for piggyback access — photo light off vehicle', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-remove-r', stepOrder: 14, taskName: '14. Remove vehicle RIGHT light for piggyback access — photo light off vehicle', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-l', stepOrder: 15, taskName: '15. Wire outer LEFT combo into back of vehicle L light (piggyback splice — DRL/park/indicator); photo join', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-r', stepOrder: 16, taskName: '16. Wire outer RIGHT combo into back of vehicle R light (piggyback splice — DRL/park/indicator); photo join', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-wire-fog', stepOrder: 17, taskName: '17. Wire centre fog lights into vehicle fog circuit (piggyback L+R); photo both joins', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'fb-lights-joins', stepOrder: 18, taskName: '18. All light splices heat-shrink/soldered — no twist-tape; loom clear of heat/pinch; photo joins', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'fb-lights-refit-l', stepOrder: 19, taskName: '19. Refit vehicle LEFT light — fasteners seated and tightened; photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-refit-r', stepOrder: 20, taskName: '20. Refit vehicle RIGHT light — fasteners seated and tightened; photo', requiresPhoto: true, skippable: false },
      { id: 'fb-lights-test', stepOrder: 21, taskName: '21. Function test lights: DRL/park L+R, indicator L+R+hazards, both fogs — photo each mode working', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-3', stepOrder: 22, taskName: '22. Front parking sensors seated (L/R) — 4 photos: top + side each side', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-5', stepOrder: 23, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 24, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
