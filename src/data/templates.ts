...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      { id: 'fb-lights-joins', stepOrder: 17, taskName: '17. All light splices heat-shrink/soldered — no twist-tape; loom clear of heat/pinch; photo joins', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 2 },
      { id: 'fb-lights-test', stepOrder: 18, taskName: '18. Function test lights: DRL/park L+R, indicator L+R+hazards, both fogs — photo each mode working', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-3', stepOrder: 19, taskName: '19. Front parking sensors seated (L/R) — 4 photos: top + side each side', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-5', stepOrder: 20, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 21, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
