...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'rst-2', stepOrder: 5, taskName: 'Rear springs/shocks removed — photo of mounts; hardware bagged/counted', requiresPhoto: true, skippable: false },
      { id: 'rst-3', stepOrder: 6, taskName: 'New rear springs seated correctly', requiresPhoto: false, skippable: false },
      { id: 'rst-4', stepOrder: 7, taskName: 'Rear shock bolts torqued — photo of both sides', requiresPhoto: true, skippable: false },
      { id: 'rst-5', stepOrder: 8, taskName: 'Brake lines and ABS wiring checked for stretch / clearance', requiresPhoto: false, skippable: false },
      { id: 'rst-6', stepOrder: 9, taskName: 'Trailer plug / tow socket fitted and wired', requiresPhoto: true, skippable: false },
      { id: 'rst-7', stepOrder: 10, taskName: 'Trailer lights function test (indicators, brakes, tail, reverse)', requiresPhoto: false, skippable: false },
      { id: 'rst-8', stepOrder: 11, taskName: 'Final rear ride-height and tow-plug photos', requiresPhoto: true, skippable: false },
      ...FINAL_INSPECTION,
