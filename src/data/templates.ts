...
export const PACKAGE_TEMPLATES: PackageTemplate[] = [
  {
    ...
    steps: [
      ...
      { id: 'fb-3', stepOrder: 13, taskName: '13. Front parking sensors seated (L/R) — 4 photos: top + side each side', requiresPhoto: true, skippable: false, photoMode: 'multi', minPhotos: 4 },
      { id: 'fb-4', stepOrder: 14, taskName: 'Indicators / fog lights / DRL mounted with correct fasteners', requiresPhoto: false, skippable: true },
      { id: 'fb-5', stepOrder: 15, taskName: 'Spotlights / light bar mounts fitted (if on job)', requiresPhoto: false, skippable: true },
      { id: 'fb-6', stepOrder: 16, taskName: 'Front camera / radar remounted (if fitted)', requiresPhoto: false, skippable: true },
